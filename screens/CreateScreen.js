...
export default class CreateScreen extends React.Component{
    ...
    render() {
        return (
            ...
            <TouchableOpacity style={styles.button} onPress={ () => this.handleBlogPost()} >
                <Text style={{color:"#FFF" , fontWeight:"500" , fontSize: 18}} >Post</Text>
            </TouchableOpacity>
	    <TouchableOpacity style={styles.button} onPress={ () => this.props.navigation.navigate('Home')} >
                <Text style={{color:"#FFF" , fontWeight:"500" , fontSize: 18}} >Back</Text>
            </TouchableOpacity>
